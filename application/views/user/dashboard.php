    ...
    <?php foreach ($buku as $bk) : ?>
      <div class="card ml-3" style="width: 12rem;">
        ...
        <div class="card-body">
          ...
          <?php echo anchor('user/dashboard/keranjang/' . $bk->id_buku, '<div class="btn btn-sm btn-primary">Tambah Kerajang</div>') ?>
          <?php echo anchor('user/dashboard/detail/' . $bk->id_buku, '<div class="btn btn-sm btn-success">Detail</div>') ?>
        </div>
      </div>
    <?php endforeach; ?>
  </div>
