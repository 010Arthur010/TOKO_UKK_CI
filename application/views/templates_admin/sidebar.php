  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('dashboard') ?>">
        ...
        <div class="sidebar-brand-text mx-3">TOKO BUKU ADMIN</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('distributor') ?>">Data Distributor</a>
            <a class="collapse-item" href="<?= base_url('pasok') ?>">Data Pasok</a>
            <a class="collapse-item" href="<?= base_url('buku') ?>">Data Buku</a>
            <a class="collapse-item" href="<?= base_url('kasir') ?>">Data Kasir</a>
            <a class="collapse-item" href="<?= base_url('penjualan') ?>">Data Penjualan</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('data_detail'); ?>">
